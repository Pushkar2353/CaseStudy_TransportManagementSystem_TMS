    ...
    class Program
    {
        ...
        /*
               ...
               static void Main(string[] args)
               {
                   ...
                   try
                   {
                       // Example of getting a vehicle
                       Vehicle vehicle = service.GetVehicleById(1); // Pass a vehicle ID to retrieve
                       Console.WriteLine($"Vehicle retrieved: {vehicle.Model}");

                       // Example of getting a booking
                       Booking booking = service.GetBookingById(11); // Pass a booking ID to retrieve
                       Console.WriteLine($"Booking retrieved: {booking.Status}");
                   }
